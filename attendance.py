...
# This part is image labels setting start
        ...
        #title section
        title_lb1 = Label(bg_img,text="Attendance management",font=("verdana",20,"bold"),bg="navyblue",fg="white")
        ...
        #Student id
        studentId_label = Label(left_frame,text="Student id:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Student Roll
        student_roll_label = Label(left_frame,text="Student Roll:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Studnet Name
        student_name_label = Label(left_frame,text="Studnet Name:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Exprot button
        update_btn=Button(btn_frame,command=self.exportCsv,text="CSV export",width=12,font=("verdana",12,"bold"),fg="white",bg="navyblue")
        ...
        # Right Label Frame
        right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Detail",font=("verdana",12,"bold"),fg="navyblue")
    ...
    def delete_data(self):
        if self.var_id.get()=="":
            messagebox.showerror("Error","Student ID must be requested!",parent=self.root)
        else:
            try:
    ...
    def exportCsv(self):
        try:
            ...
            with open(fln,mode="w",newline="") as myfile:
                ...
                messagebox.showinfo("Successfuly","Data export successful!")
        except Exception as es:
                messagebox.showerror("Error",f"Due to: {str(es)}",parent=self.root)
