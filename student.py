...
class Student:
    def __init__(self, root):
        ...
        # title section
        title_lb1 = Label(bg_img, text="Student information management", font=("verdana", 20, "bold"), bg="navyblue",
                          fg="white")
        ...
        # label Course
        cou_label = Label(current_course_frame, text="Course", font=("verdana", 10, "bold"), bg="white", fg="navyblue")
        ...
        # label Year
        year_label = Label(current_course_frame, text="Year", font=("verdana", 10, "bold"), bg="white", fg="navyblue")
        ...
        # label Semester
        year_label = Label(current_course_frame, text="Semester", font=("verdana", 10, "bold"), bg="white",
                           fg="navyblue")
        ...
        # Class Didvision
        student_div_label = Label(class_Student_frame, text="Class Didvision:", font=("verdana", 10, "bold"),
                                  fg="navyblue", bg="white")
        ...
        # Roll No
        student_roll_label = Label(class_Student_frame, text="Roll No:", font=("verdana", 10, "bold"), fg="navyblue",
                                   bg="white")
        ...
        # Gender
        student_gender_label = Label(class_Student_frame, text="Gender:", font=("verdana", 10, "bold"), fg="navyblue",
                                     bg="white")
        ...
        # Phone Number
        student_mob_label = Label(class_Student_frame, text="Phone Number:", font=("verdana", 10, "bold"),
                                  fg="navyblue", bg="white")
        ...
        radiobtn1 = ttk.Radiobutton(class_Student_frame, text="No Photo Sample", variable=self.var_radio1, value="Not")
        ...
        # take photo button
        take_photo_btn = Button(btn_frame, command=self.generate_dataset, text="Take photo", width=11,
                                font=("verdana", 10, "bold"), fg="white", bg="navyblue")
        take_photo_btn.grid(row=0, column=4, padx=5, pady=10, sticky=W)

        # update photo button
        update_photo_btn = Button(btn_frame, text="Update photo", width=11, font=("verdana", 10, "bold"), fg="white",
                                  bg="navyblue")
        ...
        # Phone Number
        search_label = Label(search_frame, text="Student search:", font=("verdana", 10, "bold"), fg="navyblue",
                             bg="white")
        ...
        search_combo = ttk.Combobox(search_frame, textvariable=self.var_searchTX, width=12,
                                    font=("verdana", 10, "bold"), state="readonly")
        search_combo["values"] = ("Student ID", "Email")
        ...
        showAll_btn = Button(search_frame, command=self.fetch_data, text="showAll", width=10,
                             font=("verdana", 10, "bold"), fg="white", bg="navyblue")
        ...
        "ID", "Name", "Dep", "Course", "Year", "Sem", "Div", "Gender", "DOB", "MobNo", "Address", "RollNo", "Email",
        ...
        self.student_table.heading("MobNo", text="mobile")
        ...
        self.student_table.column("MobNo", width=120)
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_course.get == "Select Course" or self.var_year.get() == "Select Year" or self.var_semester.get() == "Select Semester" or self.var_std_id.get() == "" or self.var_std_name.get() == "" or self.var_div.get() == "" or self.var_roll.get() == "" or self.var_gender.get() == "" or self.var_dob.get() == "" or self.var_email.get() == "" or self.var_mob.get() == "" or self.var_address.get() == "" or self.var_teacher.get() == "":
            messagebox.showerror("Error", "Please fill in all fields as required!", parent=self.root)
        else:
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Success", "All recordings have been saved!", parent=self.root)
    ...
    def fetch_data(self):
        conn = mysql.connector.connect(user='root', password='root', host='localhost', database='face_recognizer',
                                       port=3306)
        mycursor = conn.cursor()
    ...
    def update_data(self):
        if self.var_dep.get() == "Select Department" or self.var_course.get == "Select Course" or self.var_year.get() == "Select Year" or self.var_semester.get() == "Select Semester" or self.var_std_id.get() == "" or self.var_std_name.get() == "" or self.var_div.get() == "" or self.var_roll.get() == "" or self.var_gender.get() == "" or self.var_dob.get() == "" or self.var_email.get() == "" or self.var_mob.get() == "" or self.var_address.get() == "" or self.var_teacher.get() == "":
            ...
            try:
                Update = messagebox.askyesno("Update", "Do you want to fix it!", parent=self.root)
                if Update > 0:
                    conn = mysql.connector.connect(user='root', password='root', host='localhost',
                                                   database='face_recognizer', port=3306)
                    mycursor = conn.cursor()
                    mycursor.execute(
                        "update student set Name=%s,Dep=%s,Course=%s,Year=%s,Semester=%s,Division=%s,Gender=%s,DOB=%s,Mobile_No=%s,Address=%s,Roll_No=%s,Email=%s,Teacher=%s,PhotoSample=%s where Student_ID=%s",
                        (
                            self.var_std_name.get(),
                            self.var_dep.get(),
                            self.var_course.get(),
    ...
    def delete_data(self):
        if self.var_std_id.get() == "":
            ...
            try:
                delete = messagebox.askyesno("Delete", "You may want to delete?", parent=self.root)
                if delete > 0:
                    conn = mysql.connector.connect(user='root', password='root', host='localhost',
                                                   database='face_recognizer', port=3306)
                    mycursor = conn.cursor()
    ...
    def search_data(self):
        if self.var_search.get() == "" or self.var_searchTX.get() == "Select":
            ...
            try:
                ...
                sql = "SELECT Student_ID,Name,Dep,Course,Year,Semester,Division,Gender,Dob,Mobile_No,Address,Roll_No,Email,Teacher,PhotoSample  FROM student where Student_ID='" + str(
                    self.var_search.get()) + "'"
    ...
    def generate_dataset(self):
        if self.var_dep.get() == "Select Department" or self.var_course.get == "Select Course" or self.var_year.get() == "Select Year" or self.var_semester.get() == "Select Semester" or self.var_std_id.get() == "" or self.var_std_name.get() == "" or self.var_div.get() == "" or self.var_roll.get() == "" or self.var_gender.get() == "" or self.var_dob.get() == "" or self.var_email.get() == "" or self.var_mob.get() == "" or self.var_address.get() == "" or self.var_teacher.get() == "":
            ...
            try:
                ...
                messagebox.showinfo("Result", "Completed dataset creation!", parent=self.root)
            except Exception as es:
                messagebox.showerror("Error", f"Due to: {str(es)}", parent=self.root)
